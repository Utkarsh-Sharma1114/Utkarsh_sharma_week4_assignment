...
import dayjs from "dayjs"; // install and import dayjs liberary

function JobCard(props) {
  // calculate the number of days....the job was posted
  // const skills = ["Javascript", "React", "Nodejs"];
  const date1 = dayjs(Date.now()); // get the current date and time
  const diffInDays = date1.diff(props.postedOn, "day"); // calculate the difference in days between now and the posted date
  return (
